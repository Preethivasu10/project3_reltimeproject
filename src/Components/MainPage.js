       ...
       <div className='row'>
          ...
          <div className='col-12 col-sm-12 col-md-12  col-lg-4'>
            <div className='parts-logo'>
              <div className='mt-5'>
                <img className='logo1' src="https://reltime-super-app.netlify.app/images/logo.png" style={{ height: '5vh' }} alt="logo2" />       
                <img  className='logo2' src="https://reltime-super-app.netlify.app/images/logo2.png" style={{height:'10vh'}} alt="logo2"/>
              </div>
            </div>
